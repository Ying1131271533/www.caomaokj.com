...
$input->SetOut_trade_no("sdkphp123456789" . date("YmdHis")); // 商户订单号
$input->SetTotal_fee("1"); // 标价金额
$input->SetTime_start(date("YmdHis")); // 交易起始时间
$input->SetTime_expire(date("YmdHis", time() + 600)); // 交易结束时间
$input->SetGoods_tag("test"); // 订单优惠标记，使用代金券或立减优惠功能时需要的参数
$input->SetNotify_url("http://paysdk.weixin.qq.com/notify.php"); // 商品ID 自定义
$input->SetTrade_type("NATIVE"); // 支付交易类型 JSAPI -JSAPI支付 NATIVE -Native支付 APP -APP
