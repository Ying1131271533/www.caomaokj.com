...
function comment(id, acid) {
    ...
    $.ajax({
        url: "/index/activity_api/activityComment",
        type: "POST",
        data: {
            comment: comment,
            id: id,
...
function getArticleComment() {
    ...
    $.ajax({
        url: "/index/activity_api/getactivityComment",
        type: "POST",
        data: { id: id },
        dataType: "json",
        success: function (json) {
...
function collect(id) {
	var loadding = layer.load();
	$.ajax({
		url: "/index/activity_api/activityCollect",
		type: "POST",
		data: { id: id },
		dataType: "json",
		success: function(json) {
...
function like(id) {
	$.ajax({
		url: "/index/activity_api/activityLike",
		type: "POST",
		data: { id: id },
		dataType: "json",
		success: function(json) {
