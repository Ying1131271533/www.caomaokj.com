...
$(function () {
    ...
    $("#sub-login").click(function () {
        ...
        $.ajax({
            url: "https://www.caomaokj.com/index/login_api/login",
            type: "POST",
            data: {
                usercode: usercode,
                password: password,
    ...
    $("#sub-register").click(function () {
        ...
        if (!password.match(/^[a-zA-Z0-9]{8,20}$/)) {
            layer.msg('密码不符合规范，长度必须为8-20', {icon: 0});
            $("#password").focus();
            return false;
        }
        ...
        $.ajax({
            url: "https://https://www.caomaokj.com/index/login_api/register",
            type: "POST",
