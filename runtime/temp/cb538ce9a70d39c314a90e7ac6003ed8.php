<?php /*a:2:{s:45:"../application/usezan/view/activity\join.html";i:1645773385;s:45:"../application/usezan/view/public\header.html";i:1650422517;}*/ ?>
<!DOCTYPE html>
...
<div class="mainbox animated fadeInRight">
	...
	<table  class="search_table" width="100%">
		<tr>
			<td class="search">
				<form action="<?php echo url('activity/join'); ?>" method="post">
					<input id="title" type="text" class="input-text" name="activity_id" placeholder="活动id搜索" value="<?php echo input('activity_id'); ?>" style="float:left;">
					<input id="title" type="text" class="input-text" name="title" placeholder="活动标题搜索" value="<?php echo input('title/s'); ?>" style="float:left;">
					...
					<a href="<?php echo url('activity/join'); ?>" class="button">重置</a>
	...
	<form name="myform" id="myform" action="<?php echo url('activity/sendGroupMessage'); ?>" method="post">
				...
				<thead>
		      	...
		      	<tbody>
					...
					<tr height="70">
						...
						<td align="center"><a href="<?php echo url('index/activity/detail', ['id' => $value['activity_id']]); ?>" target="_blank"><?php echo htmlentities($value['title']); ?></a></td>

						<td align="center">
		                    <a onclick="ajax_status(this)" data-id="<?php echo htmlentities($value['id']); ?>" data-url="<?php echo url('ajax/status', ['id' => $value['id'], 'value' => $value['connect_status'], 'field' => 'connect_status', 'db' => 'activity_join']); ?>" class="bth-a ajax-status <?php echo $value['connect_status']==1 ? ''  :  'error-c'; ?>"></a>
		                </td>

						<td align="center"><?php echo htmlentities($value['create_time']); ?></td>
						<td align="center" style="width: 30px;">
							<input value="查看详情" data-url="<?php echo url('activity/joinDetail', ['id' => $value['id']]); ?>" class="keyword-article button">
						</td>
					</tr>
					<?php endforeach; ?>
		      	</tbody>
