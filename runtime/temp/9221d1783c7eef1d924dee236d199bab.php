<?php /*a:3:{s:45:"../application/usezan/view/college\index.html";i:1646380612;s:45:"../application/usezan/view/public\header.html";i:1630479318;s:49:"../application/usezan/view/public\menu_right.html";i:1574769382;}*/ ?>
<!DOCTYPE html>
...
<table  class="search_table" width="100%">
	<tr>
		<td class="search">
			<form action="<?php echo url('college/index'); ?>" method="get">
				...
				<a href="<?php echo url('college/index'); ?>" class="button">重置</a>
			</form>
		</td>
	</tr>
</table>
...
<div class="table-list">
      	...
      	<tbody>
			...
			<tr>
				...
				<td  width="50" align='center'>
					<a onclick="ajax_status(this)" data-id="<?php echo htmlentities($v['id']); ?>" data-url="<?php echo url('ajax/status', ['id' => $v['id'], 'value' => $v['recommend'], 'field' => 'recommend', 'db' => 'college']); ?>" class="bth-a ajax-status <?php echo $v['recommend']==1 ? htmlentities($v['recommend']) : 'error-c'; ?>"></a>
				</td>
				
				<td align="left"><img width="50" src="<?php echo !empty($v['thumb']) ? htmlentities($v['thumb']) : '/static/admin/Images/nodata.svg'; ?>" style="cursor:pointer;" onclick="open_img(this)" /></td>
				...
				<td align="center"><?php echo htmlentities($v['create_time']); ?></td>
				<td align="center">
					<?php if($v['status'] == '1'): ?>
				...
				<td align="left">
					<a href="<?php echo url('college/edit'); ?>?id=<?php echo htmlentities($v['id']); ?>&tree=<?php echo htmlentities($tree_id); ?>"><?php echo lang('edit'); ?></a> |
					<a href="javascript:confirm_delete('<?php echo url('college/delete'); ?>?id=<?php echo htmlentities($v['id']); ?>&tree=<?php echo htmlentities($tree_id); ?>')"><?php echo lang('delete'); ?></a>
				</td>
			</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
      	</tbody>
    ...
    <div class="btn">
	    <input  type="button" class="button" value="<?php echo lang('listorder'); ?>" onclick="myform.action='<?php echo url('college/listorder'); ?>';$('#myform').submit();" />
    </div>
</div>
</form>
</div>
