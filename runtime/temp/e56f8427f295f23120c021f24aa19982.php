<?php /*a:8:{s:45:"../application/index/view/platform\index.html";i:1645067041;s:42:"../application/index/view/layout\base.html";i:1645521738;s:44:"../application/index/view/layout\header.html";i:1645066486;s:41:"../application/index/view/layout\top.html";i:1646990834;s:42:"../application/index/view/layout\menu.html";i:1647832070;s:45:"../application/index/view/layout\toolbar.html";i:1624259554;s:44:"../application/index/view/layout\footer.html";i:1642580253;s:46:"../application/index/view/layout\open_img.html";i:1645170607;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>跨境电商入驻 - 草帽跨境</title>
...
<!-- css -->
<link rel="stylesheet" href="/static/akali/css/platform.css?<?php echo htmlentities($time); ?>" type="text/css">
<link rel="stylesheet" href="/static/kjzd/css/shop.css?<?php echo htmlentities($time); ?>" type="text/css">
<!-- js -->
...
<div class="container body-container">
    <a target="_blank" href="<?php echo htmlentities($banner['url']); ?>">
        <div class="p_logo" style="width:100%;border:0px solid;height: 300px;padding: 0;background: url(<?php echo htmlentities($banner['thumb']); ?>);
    background-position: center center;margin-top: 9px;"></div>
    </a>
    <div class="nav_div_huodong">
    </div>
    <div class="main-div">
        <div class="p_detail" style="margin:0 0 3rem 0;">
            <div class="type_platform">
                <a href="<?php echo url('platform/index'); ?>"><span class="<?php echo $id=='' ? 'zhou_span_select'  :  ''; ?>">全部</span></a>
                <?php foreach($platform as $value): ?>
                <span data-id="<?php echo url('platform/detail', ['id' => $value['id']]); ?>" class="<?php echo $id==$value['id'] ? 'zhou_span_select'  :  ''; ?> type_span_zhou"><?php echo htmlentities($value['name']); ?></span>
                <?php endforeach; ?>
            </div>
            <div class="content_box">

                <div class="platform-tabs el-tabs el-tabs--top">
                    <div class="el-tabs__content">

                        <div role="tabpanel" id="pane-0" aria-labelledby="tab-0" class="el-tab-pane" style="color: rgb(153, 153, 153);">

                            <div class="article-list">
                                <div class="platform-list">

                                    <?php foreach($platform as $value): ?>
                                    <a target="_blank" href="<?php echo url('detail', ['id' => $value['id']]); ?>" class="platform-item">
                                        <div class="el-image"><img src="<?php echo htmlentities($value['logo']); ?>" class="el-image__inner">
                                            <!---->
                                        </div>
                                        <p class="platform-title"><?php echo htmlentities($value['name']); ?></p>
                                        <p class="platform-content"><?php echo htmlentities($value['title']); ?></p>
                                        <p class="platform-work"><span>24小时</span>下发注册链接
                                        </p> <button>我要开店</button>
                                    </a>
    ...
    <script type="text/javascript">
        $(function() {
            $('#logistics-a').removeClass('active');
            $('#resource-a').addClass('active').find('img').attr('src', "https://www.kuajingyan.com/img/home/xiajiantou2.png");
            $('#logistics-a,.home_nav_baike').hover(function() {
            ...
            $(".logo_img").click(function() {
                var oldP = $('.selected').attr("data-itme");
                var newP = $(this).attr("data-itme");
                $(".logo_div").find(".logo_img").removeClass('selected');
                if (oldP && oldP == newP) {
                    $(".partner_item").show();
                } else {
                    $(this).addClass("selected");
                    var item = 'partber_' + newP;
                    $(".partner_item").hide();
                    $("." + item).show();
                }
            });
    ...
    <script type="text/javascript">
        $(function() {
            ...
            if (current_url.indexOf("/s") != -1) {
                var top = $('.type_span_zhou').offset().top - 295 + "px";
                $("html, body").animate({
                    scrollTop: top
                }, {
                    duration: 500,
