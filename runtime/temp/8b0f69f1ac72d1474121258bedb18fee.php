<?php /*a:8:{s:44:"../application/index/view/college\index.html";i:1646883900;s:42:"../application/index/view/layout\base.html";i:1645521738;s:44:"../application/index/view/layout\header.html";i:1645066486;s:41:"../application/index/view/layout\top.html";i:1646990834;s:42:"../application/index/view/layout\menu.html";i:1647832070;s:45:"../application/index/view/layout\toolbar.html";i:1624259554;s:44:"../application/index/view/layout\footer.html";i:1642580253;s:46:"../application/index/view/layout\open_img.html";i:1645170607;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>草帽学院 - 草帽跨境</title>
...
<!-- css -->
<link rel="stylesheet" href="/static/college/css/course.css">
<!-- js -->
<script src="/static/college/js/swiper.js"></script>
...
<script>
    ...
    <div class="course_body">
        ...
        <div class="course_nav" style="z-index: 99999999;">
            <div style="width: 1200px;height: 48px;margin: 0 auto;">
                ...
                <span class="course_nav_span pointer course-cate-name course-cate-nav-<?php echo htmlentities($key+1); ?>" attr-cate-data="<?php echo htmlentities($key+1); ?>" style="border-bottom: 0px solid #fc9d27;"><?php echo htmlentities($value['catname']); ?></span>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="course_container">
            ...
            <div class="top_ongoing_div">
                ...
                <a href="<?php echo url('college/detail', ['id' => $value['id']]); ?>">
                    <div class="ongoing_list">
                        <div class="ongoing_list_img" style="background: url(<?php echo htmlentities($value['thumb']); ?>);background-size: 100% 100%;background-position: center center;">

                            <?php if($value['end_time'] > time()): ?>
                            <div class="course_title_tips"><?php echo htmlentities($value['category']['catname']); ?></div>
                            <?php else: ?>
                            <div class="course_title_tips" style="background: #9FA0A3;" data-coursetype="<?php echo htmlentities($value['category']['catname']); ?>">已结束</div>
                            <?php endif; ?>
                        </div>

                        <div class="ongoing_list_title"><?php echo htmlentities($value['title']); ?></div>
                        <div class="ongoing_list_date"><?php echo date('Y-m-d H:i:s', $value['start_time']); ?> 至 <?php echo date('Y-m-d H:i:s', $value['end_time']); ?></div>
                        <div class="ongoing_list_address">
                            <span class="pull-left"><?php echo htmlentities($value['address']); ?></span>
                            <span class="pull-right price_span">¥<?php echo number_format($value['tickets']['0']['discount_price'], 2); ?></span>
                        </div>
                    </div>
                </a>
                <?php endforeach; ?>
            ...
            <?php foreach($category as $key => $value): ?>
            <div id="cate-<?php echo htmlentities($key+1); ?>" class="course_tips cate-<?php echo htmlentities($key+1); ?>" cate-attr="<?php echo htmlentities($key+1); ?>"><?php echo htmlentities($value['catname']); ?></div>
            <div class="top_ongoing_div">

                <?php foreach($college as $k => $val): if($value['id'] == $val['category']['id']): ?>
                <a href="<?php echo url('college/detail', ['id' => $val['id']]); ?>">
                    <div class="ongoing_list">
                        <div class="ongoing_list_img"
                            style="background: url(<?php echo htmlentities($val['thumb']); ?>);background-size: 100% 100%;background-position: center center;">
                            <div class="course_title_tips"><?php echo htmlentities($value['catname']); ?></div>
                        </div>

                        <div class="ongoing_list_title"><?php echo htmlentities($val['title']); ?></div>
                        <div class="ongoing_list_date"><?php echo date('Y-m-d H:i:s', $val['start_time']); ?> 至 <?php echo date('Y-m-d H:i:s', $val['end_time']); ?></div>
                        <div class="ongoing_list_address">
                            <span class="pull-left"><?php echo htmlentities($val['address']); ?></span>
                            <span class="pull-right price_span">¥<?php echo number_format($val['tickets']['0']['discount_price'], 2); ?></span>
                        </div>
                    </div>
                </a>
                <?php endif; ?>
    ...
    <script src="/static/college/js/course.js?<?php echo htmlentities($time); ?>"></script>
    <script>
        //从底部超链接跳转过来的锚点
