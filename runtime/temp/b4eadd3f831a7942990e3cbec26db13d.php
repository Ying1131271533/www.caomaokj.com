...
<link rel="stylesheet" type="text/css" href="/static/akali/css/home.css">
<link rel="stylesheet" type="text/css" href="/static/akali/css/styles.css">
<link rel="stylesheet" type="text/css" href="/static/akali/css/touchTouch.css">

<!-- js -->
<script type="text/javascript" src="/static/akali/js/touchTouch.jquery.js"></script>
                ...
                <div class="swiper-container swiper-container-horizontal swiper-container-fade" style="margin-top:15px;">
                    ...
                    <div class="swiper-wrapper" style="transition-duration: 0ms;">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="<?php echo htmlentities($key); ?>">
                            <img alt="草帽跨境" style="width:100%;width:100%;cursor: pointer;" class="banner_href" data-type="pc" data-id="157" data-url="<?php echo htmlentities($value['url']); ?>" src="<?php echo htmlentities($value['thumb']); ?>">
                        </div>
                        <?php endforeach; ?>
...
<div class="left_cont">
    ...
    <div class="load-more" id="index_more" onclick="getMoreArticle()">
        ...
        <div class="index-right">
            ...
            <?php if(empty($college_list) || (($college_list instanceof \think\Collection || $college_list instanceof \think\Paginator ) && $college_list->isEmpty())): ?>
            <div class="officialAdvert" style="margin-bottom:20px;">
                <a href="<?php echo url('index/home/article', ['id' => 67]); ?>">
                    <img src="/static/akali/images/article_01.jpg" title="戳我领资料" alt="戳我领资料">
                </a>
            </div>
            ...
            <div class="layui-carousel" id="test1">
                <div carousel-item>
                  <?php foreach($college_list as $key => $value): ?>
