<?php /*a:2:{s:46:"../application/usezan/view/community\edit.html";i:1650699164;s:45:"../application/usezan/view/public\header.html";i:1650422517;}*/ ?>
<!DOCTYPE html>
    ...
    <form name="myform" id="myform" action="" method="post">
        <table cellpadding=0 cellspacing=0 class="table_form" width="100%">
            <tr>
                ...
                <td width="90"><input type="text" class="input-text" name="name" value="<?php echo htmlentities($community['name']); ?>" size="50" placeholder="名称" validate="maxlength:30,required:true"></td>
            </tr>
                ...
                <td>
                    <div>
                        <div class="img-upload">
                            <img class="clogo" width="100" onclick="up_img('clogo','logo','jpg,gif,png,jpeg','10485760','290px',0);" src="<?php echo htmlentities($community['logo']); ?>" alt="上传logo" style="cursor:pointer;">
                            <input type="hidden" class="logo" name="logo" value="<?php echo htmlentities($community['logo']); ?>" >
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="description" value="<?php echo htmlentities($community['description']); ?>" size="50" placeholder="描述" validate="maxlength:120,required:true">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="service" value="<?php echo htmlentities($community['service']); ?>" size="50" placeholder="主推服务" validate="maxlength:50">
                </td>
            </tr>

            <tr>
                <td width="90"><font color="red">*</font><label>简介：</label></td>
                <td><textarea rows="7" cols="65" name="introduction" placeholder=" 简介" validate="required:true"><?php echo htmlentities($community['detail']['introduction']); ?></textarea></td>
            </tr>

            <tr>
                <td width="90"><font color="red">*</font><label>官方网站：</label></td>
                <td>
                    <input type="text" class="input-text" name="url" value="<?php echo htmlentities($community['url']); ?>" size="50" placeholder="主推服务" validate="required:true,maxlength:100">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="address" value="<?php echo htmlentities($community['address']); ?>" size="50" placeholder="地址"validate="maxlength:60,required:true">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="connect" value="<?php echo htmlentities($community['connect']); ?>" size="50" placeholder="联系方式"validate="maxlength:50,required:true">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:1000px;">
                    ...
                    <div id="community-img" style="overflow: hidden;">
                        <?php foreach($community['imgs'] as $value): ?>
                        <div class="img-upload" style="float: left;">
                            <img width="100" src="<?php echo htmlentities($value['path']); ?>" alt="上传imgs" style="cursor:pointer;">
                            <input type="hidden" name="imgs[]" value="<?php echo htmlentities($value['path']); ?>" >
                        </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <tr>
                <td>状态</td>
                <td>
                    <label><input type="radio" class="input_radio" name="status" value="1" <?php echo $community['status']==1 ? 'checked'  :  ''; ?>> 开启</label>&nbsp;&nbsp;
                    <label><input type="radio" class="input_radio" name="status" value="0" <?php echo $community['status']==0 ? 'checked'  :  ''; ?>> 关闭</label>
                </td>
            </tr>
