<?php /*a:8:{s:45:"../application/index/view/activity\index.html";i:1645432614;s:42:"../application/index/view/layout\base.html";i:1645521738;s:44:"../application/index/view/layout\header.html";i:1645066486;s:41:"../application/index/view/layout\top.html";i:1646990834;s:42:"../application/index/view/layout\menu.html";i:1647832070;s:45:"../application/index/view/layout\toolbar.html";i:1624259554;s:44:"../application/index/view/layout\footer.html";i:1642580253;s:46:"../application/index/view/layout\open_img.html";i:1645170607;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>跨境活动 - 草帽跨境</title>
...
<link rel="stylesheet" type="text/css" href="/static/akali/css/custom.css">
<link href="/static/akali/css/indexnew.css?<?php echo htmlentities($time); ?>" rel="stylesheet" type="text/css">
<link type="text/css" rel="stylesheet" href="/static/akali/css/laypage.css" id="laypagecss">
<!-- js -->
<script type="text/javascript" src="/static/akali/js/icheck.min.js"></script>
<script type="text/javascript" src="/static/akali/js/index.js?<?php echo htmlentities($time); ?>"></script>
<script src="/static/akali/js/activity_ad_click.js"></script>
<script src="/static/akali/js/laypage.js"></script>
...
<div class="container body-container">
    ...
    <div class="main-div">
                ...
                <li class="select-list" id="type">
                    <div class="show-info show">
                        ...
                        <div class="list-area">
                            ...
                            <span class="search" data-id="<?php echo htmlentities($value['id']); ?>">
        ...
        <div class="data-body" style="background-color: #fff">
            <input type="hidden" id="dataCount" value="<?php echo htmlentities($count); ?>">
            ...
            <div class="activity_list_div">
                ...
                <div class="img-box">
                    <div class="item-img">
                        <a title="<?php echo htmlentities($value['title']); ?>" href="<?php echo url('detail', ['id' => $value['id']]); ?>">
                            <img src="<?php echo htmlentities($value['thumb']); ?>" alt="<?php echo htmlentities($value['title']); ?>">
                        </a>
                    ...
                    <div class="item-text">
                        <h4>
                            <a title="<?php echo htmlentities($value['title']); ?>" href="<?php echo url('detail', ['id' => $value['id']]); ?>"><?php echo htmlentities($value['title']); ?></a>
                        </h4>
                        <p class="font14"><i class="fa fa-clock-o"></i> <?php echo $value['endtime']>time() ? '进行中'  :  '已结束'; ?></p>
                        <p class="font14">
                            <i class="fa fa-map-marker"></i>
                            <span class="activity-local"><?php echo htmlentities($value['address']); ?></span>
                            <span class="pull-right orange-font"> <?php echo empty($value['discount']) ? '免费' : "￥" . number_format($value['discount'], 2); ?> </span>
                        </p>
                    </div>
                </div>
                <?php endforeach; ?>
