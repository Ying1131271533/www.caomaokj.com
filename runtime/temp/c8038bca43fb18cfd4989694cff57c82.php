<?php /*a:8:{s:47:"../application/index/view/community\detail.html";i:1650535960;s:42:"../application/index/view/layout\base.html";i:1645521738;s:44:"../application/index/view/layout\header.html";i:1645066486;s:41:"../application/index/view/layout\top.html";i:1646990834;s:42:"../application/index/view/layout\menu.html";i:1647832070;s:45:"../application/index/view/layout\toolbar.html";i:1624259554;s:44:"../application/index/view/layout\footer.html";i:1642580253;s:46:"../application/index/view/layout\open_img.html";i:1645170607;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title><?php echo htmlentities($community['name']); ?> - 草帽跨境</title>
...
<main id="body" style="margin-top: 109px;">
    ...
    <div class="header-info">
        <div class="container">
            <div class="avatar">
                <img src="<?php echo htmlentities($community['logo']); ?>">
            </div>
            <div class="contents">
                <div class="c-title"><?php echo htmlentities($community['name']); ?></div>
                <div class="desc"><?php echo htmlentities($community['description']); ?></div>
                <div class="hinfo">
                    <!-- <?php if(!(empty($community['qq']) || (($community['qq'] instanceof \think\Collection || $community['qq'] instanceof \think\Paginator ) && $community['qq']->isEmpty()))): ?><div class="qq">QQ：<?php echo htmlentities($community['qq']); ?></div><?php endif; ?> -->
                    <div class="gw">官网：<a href="<?php echo htmlentities($community['url']); ?>" target="_blank" style="color:#ff4300">立即访问</a></div>
                    <?php if(!(empty($community['connect']) || (($community['connect'] instanceof \think\Collection || $community['connect'] instanceof \think\Paginator ) && $community['connect']->isEmpty()))): ?><div class="lx">联系方式：<?php echo htmlentities($community['connect']); ?></div><?php endif; ?>
                </div>
            </div>
        </div>
    </div>
    <div class="navmenu" style="width: 100%">
        <nav class="nav-wrap" id="navds" style="width:1100px;margin:0 auto;">
            <ul class="clearfix" style="display: flex;flex-wrap: wrap;">
                <?php if(!(empty($community['detail']['introduction']) || (($community['detail']['introduction'] instanceof \think\Collection || $community['detail']['introduction'] instanceof \think\Paginator ) && $community['detail']['introduction']->isEmpty()))): ?>
                <li><a class="sroll active" href="#s3">简介</a></li>
                <?php endif; if(!(empty($community['imgs']['0']) || (($community['imgs']['0'] instanceof \think\Collection || $community['imgs']['0'] instanceof \think\Paginator ) && $community['imgs']['0']->isEmpty()))): ?>
        ...
        <div class="content">
            <div class="container" style="padding:20px 0; padding-top: 70px;">
                ...
                <div class="textarea"style="width: 70%;line-height: 25px;">
                    ...
                    <div style="word-break:break-word;" class="edit_condit" ><?php echo $community['detail']['introduction']; ?></div>
                </div>
                <?php endif; if(!(empty($community['imgs']) || (($community['imgs'] instanceof \think\Collection || $community['imgs'] instanceof \think\Paginator ) && $community['imgs']->isEmpty()))): ?>
                    ...
                    <div style="display: flex;flex-wrap: wrap">
                        ...
                        <div class="zhutuilist">
                            <div class="thumb" style="height: auto;">
                                <img src="<?php echo htmlentities($value['path']); ?>" style="cursor:pointer;height: auto;" onclick="open_img(this)" >
                            </div>
                        </div>
                        <?php endforeach; ?>
